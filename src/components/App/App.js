        ...
        <div>
          ...
          <Switch>
            ...
            <ProtectedRoute
              ...
              render={(navProps) => (
                <UserPage
                  ...
                  // history allows us to navigate backwards and forwards using react router
            ...
            <ProtectedRoute
              ...
              path='/addplant'
              render={(navProps) => (
                <AddPlant match={navProps.match} history={navProps.history} />
              )}
            />
            ...
            />
            <ProtectedRoute exact path='/plant/:id' component={CurrentPlant} />
            <ProtectedRoute exact path='/edit/:id' component={EditPlant} />
